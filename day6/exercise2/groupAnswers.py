class GroupAnswers:
    ...
    def countAllAnsweredTheSame(self):
        allAnsweredTheSame = 0

        for answer in self.YesAnswers:
            if self.YesAnswers[answer] == self.PersonsInGroup :
                allAnsweredTheSame = allAnsweredTheSame +1

        return allAnsweredTheSame